...
import RecruiterNotification from "@/ui/recruiter/RecruiterNotification";
          ...
          <li className="dropdown user user-menu">
            ...
            <ul className="dropdown-menu animated flipInX">
              <li className="user-body">
                <Link className="dropdown-item" href="/recruiter/profile">
                  <FaRegUserCircle /> Profile
                </Link>
                <Link className="dropdown-item" href="/recruiter/support">
                  <FaHeadset /> Help Center
                </Link>
                {/* <Link className="dropdown-item" href="/recruiter/change-password">
                  <FaHeadset />Change Password
                </Link> */}
                <a className="dropdown-item customCrIcons" href="/recruiter/purchase-credit">
